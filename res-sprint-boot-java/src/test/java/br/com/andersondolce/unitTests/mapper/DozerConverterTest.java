package br.com.andersondolce.unitTests.mapper;

import static org.junit.jupiter.api.Assertions.assertEquals;

import java.util.List;

import br.com.andersondolce.data.vo.v1.PersonVO;
...
public class DozerConverterTest {
    ...
    public void parseEntityListToVOListTest() {
        List<PersonVO> outputList = (List<PersonVO>) DozerMapper.parseListObjects(inputObject.mockEntityList(), PersonVO.class);
